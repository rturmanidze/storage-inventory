...
const navItems: NavItem[] = [
  ...
  { label: 'Issued To', to: '/issued-to', icon: icons.issuedTo, group: 'Inventory' },
  { label: 'Unit Search', to: '/units', icon: icons.unitSearch, group: 'Inventory' },
  { label: 'Receive Stock', to: '/movements/receive', icon: icons.receive, group: 'Movements' },
  { label: 'Transfer', to: '/movements/transfer', icon: icons.transfer, group: 'Movements' },
  { label: 'Issue Items', to: '/movements/issue', icon: icons.issue, group: 'Movements' },
  { label: 'Return Items', to: '/movements/return', icon: icons.return, group: 'Movements' },
